...
<thead> 
       ...
       <th colspan="9" style="background-color: #364bb5"><?= $listeCreneau[$i]["FORM_LIBELLE"] ?></th>
     </thead>
...
for ($j = 0; $j < count($result); $j++) {
 ...
 <tr>
       ...
       <td><center><?= $result[$j]["CRE_SALLE"] ?></center></td>
            <td><center><button onclick="if(confirm('Voulez-vous vraiment modifier cet élément ?')==true) { window.location.href='./?action=modifInsEta&id=<?=$result[$j]['ELE_ID'] ?>'; }" > Modifier </button></center></td>
