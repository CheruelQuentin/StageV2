...
<html>
      ...
      <body>
        ...
        <table><tr><td>            
          ...
          <br>
<p><label for="ELE_NOM">Nom :</label><input id="ELE_NOM" type="text" name="ELE_NOM" size="50px" maxlength="100" value="<?=$nom?>" required pattern="[a-zA-ZÀ-ÿ-\(-\-]{1,100}" title="La première lettre doit être une majuscule"/></p>

<p><label for="ELE_PRENOM">Prénom :</label><input id="ELE_PRENOM" type="text" name="ELE_PRENOM" size="50px" maxlength="100" value="<?=$prenom?>" required pattern="[a-zA-ZÀ-ÿ-\(-\-]{1,100}" title="La première lettre doit être une majuscule" /></p>
...
<p><label for="ELE_MAIL">E-mail :</label><input id="ELE_MAIL" type="text" name="ELE_MAIL" size="50px" maxlength="150"  pattern="^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" value="<?=$mail?>" /></p>
