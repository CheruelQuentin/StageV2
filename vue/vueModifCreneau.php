...
<p><label for="CRE_SALLE"> Modification salle </label> : <input id="CRE_SALLE" type="text" name="CRE_SALLE" size="50px" maxlength="5"  required pattern="[A-Z]{1}[0-9]{3}" title="Une majuscule et trois chiffres" /></p>
