...
<?php if (getTypeUtilisateurByMail($_SESSION["UTIL_MAIL"])=="ADMIN"){ //Si l'utilisateur est un admin ...  ?>
     <body>
            ...
            <form method="post" action="./?action=genUpMDP">
                  <table>
                        <tr>
                              <td>
                        ...
                        <tr>
                              <td>
                                    <label for="UTIL_MDP3"> Répéter le mot de passe </label> : <input id="UTIL_MDP3" type="password" name="UTIL_MDP3" size="50px" maxlength="150"  onblur="verifChangementMDP();" /><span class="show-password"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23"  class="bi bi-eye-fill" viewBox="0 0 16 16">
...
<?php } else if (getTypeUtilisateurByMail($_SESSION["UTIL_MAIL"])=="ENS"){ //Si l'utilisateur est un établissement ...  ?>
 <body>
     <br><center><h2>Modification Mot de passe </h2><br>
