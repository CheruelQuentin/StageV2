      ...
      <body>
       ...
       <script src="js/verification.js"> </script>
             ...
             <table><tr><td>
              ...
              <label for="MAT_LIBELLE"> Libellé </label> : <input id="MAT_LIBELLE" type="text" name="MAT_LIBELLE" size="50px" maxlength="100" value="<?=$libelle?>" onblur="verifmodiflibelle();" /><span id = "erreurmodiflibelle" ></span>
