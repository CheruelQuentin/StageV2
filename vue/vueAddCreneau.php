...
<?php $matiere=getMatiere(); ?>
 <form method="post" action="./?action=insertCre">
	...
	<p><label for="CRE_DATE"> Nouvelle date : </label> <input id="CRE_DATE" type="date" name="CRE_DATE" size="50px" maxlength="20" placeholder="CRE_DATE"  /></p>
	<p><label for="CRE_HEUREDEB"> Nouvelle heure de début : </label> <input id="CRE_HEUREDEB" type="time" name="CRE_HEUREDEB" size="50px" maxlength="20" placeholder="CRE_HEUREDEB" /></p>
