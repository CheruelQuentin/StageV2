	...
	<link rel="stylesheet" type="text/css" href="css/style.css">
 	<form method="post" action="./?action=insertCre">
		...
		<table>
			<tr>
				<td>
					<p><label for="CRE_DATE"style="width:220px;"> Date de début *: </label> <input id="CRE_DATE" type="date" name="CRE_DATE" size="50px" maxlength="20"  class= "instyle" /></p>
					<p><label for="CRE_DATEFIN"style="width:220px;"> Date de fin *: </label> <input id="CRE_DATEFIN" type="date" name="CRE_DATEFIN" size="50px" maxlength="20"  class= "instyle" /></p>
					...
					<div class="ui-widget">
						...
						<div id="choixForm">
							<fieldset class="scheduler-border">    
        						...
        						<?php for($i=0;$i<sizeof($formation);$i++){ ?> 
